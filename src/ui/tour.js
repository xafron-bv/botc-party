export function initInAppTour() {
  ...
  const steps = [
    ...
    },
    {
      id: 'game-setup',
      title: 'Set players',
      body: 'Choose the player count and press Reset Grimoire to create tokens.',
      target: () => document.getElementById('reset-grimoire'),
    ...
    },
    {
      ...
      target: () =>
        document.querySelector('#sidebar .script-buttons') ||
    ...
    },
    {
      ...
      target: () =>
        document.querySelector('#player-circle li .player-token') ||
        document.getElementById('player-circle'),
      requiresSidebarClosed: true,
    ...
    },
    {
      ...
      body: 'right-click (or long-touch on mobile) a player to add new players before/after or remove them.',
      target: () =>
        document.querySelector('#player-circle li') || document.getElementById('player-circle'),
      requiresSidebarClosed: true
    },
    {
      id: 'reminders',
      ...
      target: () =>
        document.querySelector('#player-circle li .reminder-placeholder') ||
        document.getElementById('player-circle'),
      requiresSidebarClosed: true
    },
    {
      id: 'bluff-tokens',
      title: 'Bluff Tokens',
      body: 'These are three bluff tokens. These are characters not in play that help the evil team to win. As a player, you can give these to other players in a three-for-three claim. Click a bluff token to assign a character to it.',
      target: () =>
        document.querySelector('#bluff-tokens-container .bluff-token') ||
        document.getElementById('bluff-tokens-container'),
      requiresSidebarClosed: true
    },
    {
      id: 'offline',
  ...
  function renderStep() {
    ...
    const doRender = () => {
      const rect = targetEl
        ...
        : { left: 16, top: 16, width: 300, height: 60, right: 316, bottom: 76 };
