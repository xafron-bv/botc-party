...
export function showTouchAbilityPopup(targetElement, ability) {
  ...
  const isInfoIcon =
    targetElement.classList.contains('ability-info-icon') ||
...
document.addEventListener('click', (e) => {
  if (
    !e.target.closest('.ability-info-icon, .night-reminder-button, .token-reminder') &&
    !e.target.closest('.touch-ability-popup')
  ) {
