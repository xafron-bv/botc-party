  ...
  if (slider) {
    slider.addEventListener(
      ...
      withStateSave((e) => {
        ...
        const newPhase =
          grimoireState.dayNightTracking.phases[grimoireState.dayNightTracking.currentPhaseIndex];
...
export function showDayNightSlider() {
  ...
  settleAnimations(sliderContainer, 260);
}
...
export function updateDayNightUI(grimoireState) {
  ...
  if (enabled) {
    ...
    try {
      currentPhaseDiv.textContent = phases[currentPhaseIndex] || 'N1';
    } catch (_) {}
  }
}
