...
export const handleScriptHistoryClick = withStateSave(
  async ({ e, scriptHistoryList, grimoireState }) => {
...
export function handleScriptHistoryOnClear() {
  document
    .querySelectorAll('#script-history-list li.pressed')
...
export function addScriptHistoryListListeners({ scriptHistoryList, grimoireState }) {
  scriptHistoryList.addEventListener('click', (e) =>
    handleScriptHistoryClick({ e, scriptHistoryList, grimoireState })
  );
  ...
  scriptHistoryList.addEventListener('keydown', (e) =>
    handleScriptHistoryOnKeyDown({ e, scriptHistoryList })
  );
}
...
export function addScriptToHistory({ name, data, scriptHistoryList }) {
  ...
  const idx = history.scriptHistory.findIndex(
