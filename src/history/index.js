...
export function saveHistories() {
  try {
    localStorage.setItem('botcScriptHistoryV1', JSON.stringify(history.scriptHistory));
  } catch (_) {}
  try {
    localStorage.setItem('botcGrimoireHistoryV1', JSON.stringify(history.grimoireHistory));
  } catch (_) {}
}
